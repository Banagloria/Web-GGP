@include('admin.cms.partials.breadcrumb-editor', ['pageKey' => 'struktur', 'data' => $data])
...
<div class="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-[minmax(0,1fr)_minmax(10rem,13rem)] sm:items-end">
    ...
    <div class="min-w-0">
        @include('admin.cms.partials.page-icon-field', ['pageKey' => 'struktur', 'iconKey' => 'h1', 'data' => $data, 'label' => 'Ikon judul (H1)'])
    </div>
</div>
